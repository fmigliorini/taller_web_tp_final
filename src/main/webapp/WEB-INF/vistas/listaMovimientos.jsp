                    ...
                    <ul class="list-group list-group-body" style="">
                        <li class="list-group-item">
                            <div class="row">
                                ...
                                <div class="col-xs-3" style=""><a href="#" class="btn btn-primary a-btn-slide-text"> <span class="glyphicon glyphicon-eye-open" aria-hidden="true"></span> <span><strong>Ver</strong></span>             </a></div>
                            </div>
                        </li>
                    </ul>
                      </c:forEach>
