	...
	public ModelAndView aceptarPresupuesto(@RequestParam("idPresupuesto") Long idPresupuesto,
		...
		if (idUsuario != null) {
			...
			if (!error) {
				...
				model.put("mensaje",
						String.format(
								"No se pudo generar la factura por falta de disponibilidad de veh�culos, un representante va a estar viendo como lo pueda solucionar, en breve se est� contactando con usted v�a email para brindarle una resoluci�n.",
								idMovimiento));
